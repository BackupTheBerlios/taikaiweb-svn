...
//    @UniqueConstraint(columnNames = {"playerPosition", "qualifyingTournamentId"})
//})
...
//    private Integer id;
//    @ManyToOne
//    @JoinColumn(name = "qualifyingTournamentId", nullable = false)
//    private Tournament qualifyingTournament;
//    @ManyToOne
//    @JoinColumn(name = "advancementTournamentId", nullable = false)
